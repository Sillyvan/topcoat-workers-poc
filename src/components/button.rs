...
pub enum ButtonVariant {
    ...
    Secondary,
    /// An inverted button for use on a primary-filled surface.
    Inverse,
...
impl ButtonVariant {
    ...
    fn classes(self) -> &'static str {
        match self {
            ...
            Self::Inverse => {
                "border-transparent bg-primary-foreground text-primary shadow-xs \
                 hover:bg-primary-foreground/90 active:bg-primary-foreground/80"
            }
            Self::Outline => {
